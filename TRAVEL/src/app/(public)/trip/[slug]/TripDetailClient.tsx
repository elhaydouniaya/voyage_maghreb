...
export default function TripDetailClient({
  ...
  const handleShare = (platform: string) => {
    ...
    if (platform === "instagram" || platform === "tiktok") {
      ...
      alert(
        `Lien copié ! Partagez-le sur ${platform === "instagram" ? "Instagram" : "TikTok"} 📱`
      );
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-[#0F172A] mb-8 leading-tight tracking-tight">
                {trip.title}
              </h1>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-[#0F172A] font-black">
                    ...
                    {trip.totalSpots - trip.bookedSpots} places
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-6 p-8 bg-[#F8FAFC] rounded-[2.5rem] border border-gray-100">
                ...
                <div>
                  ...
                  <div className="text-lg font-black text-[#0F172A]">
                    {trip.meetingPoint || "À confirmer avec l'agence"}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm">
                ...
                <ul className="space-y-4">
                  {trip.exclusions.map((item, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-3 text-sm text-gray-400 font-medium opacity-60"
                    >
            ...
            <div className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-sm">
              <h2 className="text-3xl font-black text-[#0F172A] mb-12 tracking-tight">
                Programme du voyage
              </h2>
              <div className="space-y-12 relative before:absolute before:left-6 before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-50">
                {timeline.map((item, i) => (
                  <div key={i} className="relative pl-16 group">
                    ...
                    <h4 className="text-[10px] font-black text-orange-600 uppercase tracking-widest mb-1">
                      {item.day}
                    </h4>
            ...
            <div className="mt-12 bg-white rounded-[4rem] p-12 border border-gray-100 shadow-sm relative overflow-hidden group hover:border-orange-500/20 transition-all duration-500">
              ...
              <h3 className="text-3xl font-black text-[#0F172A] mb-10 flex items-center gap-4">
                <Sparkles size={28} className="text-orange-500 animate-pulse" /> Guide Touristique
                Maghreb
              </h3>
              <div className="grid md:grid-cols-2 gap-12">
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed font-medium">
                    Dans cette région, l&apos;hospitalité est une valeur sacrée. Un thé à la menthe ne
                    se refuse jamais ! C&apos;est le moment idéal pour échanger avec les locaux.
                    Prévoyez des vêtements couvrants pour les visites culturelles et les lieux de
                    culte.
                  </p>
                </div>
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed font-medium">
                    Le climat du désert est surprenant : les journées sont chaudes mais les nuits
                    peuvent être glaciales. Nous vous conseillons d&apos;adopter la technique de
                    l&apos;oignon (plusieurs couches de vêtements) pour rester à l&apos;aise tout au long
                    du voyage.
                  </p>
                </div>
              </div>
          ...
          <div className="relative">
            <div className="sticky top-32 space-y-8">
              ...
              <div
                id="booking-section"
                className="bg-white rounded-[4rem] border border-gray-100 shadow-2xl p-4 space-y-8 scroll-mt-32"
              >
                <BookingForm
                  tripId={trip.id}
                  destination={trip.destination}
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-3xl font-black text-[#0F172A] tracking-tighter">
                      {trip.destination.toLowerCase().includes("sahara") ||
                ...
                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-50">
                  {[
                    ...
                    <div key={idx} className="text-center">
                      <div className="text-[8px] font-black text-gray-300 uppercase mb-1">
                        {day.d}
                      </div>
        ...
        <div className="mt-32 space-y-12">
          <div className="flex justify-between items-end">
            <div>
              <h2 className="text-3xl font-black text-[#0F172A] tracking-tight mb-4">
                Autres aventures de l&apos;agence
              </h2>
              <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">
                Partez avec la même expertise
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {relatedTrips.map((otherTrip) => (
              <Link
                key={otherTrip.id}
                href={`/trip/${otherTrip.slug}`}
                className="group bg-white rounded-[3rem] border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500"
              >
                ...
                <div className="p-8">
                  <h4 className="font-black text-[#0F172A] mb-2 group-hover:text-orange-600 transition-colors">
                    {otherTrip.title}
                  </h4>
                  <div className="flex justify-between items-center mt-4">
                    <div>
                      <span className="text-xl font-black text-[#0F172A]">
                        {formatPriceShort(otherTrip.totalPrice)}
                      </span>
                      <p className="text-[9px] text-gray-400 font-bold">
                        (~{Math.round(otherTrip.totalPrice)} €)
                      </p>
                    </div>
